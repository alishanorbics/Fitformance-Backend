...
import { addRehab, getRehabAssignments, getRehabById, getRehabs } from '../controllers/rehab.controller.js'
...
router.get('/assignments', AuthVerifier, getRehabAssignments)
